...
Note: If Gazebo fails to start, you can resolve the issue by changing the default world used by the simulation. To do this:
...
3. In the first few lines, locate the word `baylands` and replace it with `default`.
